...
PRODUCT_BRAND_FOR_ATTESTATION := Redmi
PRODUCT_DEVICE_FOR_ATTESTATION := sapphire
PRODUCT_NAME_FOR_ATTESTATION := Redmi Note 13
PRODUCT_MODEL_FOR_ATTESTATION := Redmi Note 13
