...
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,$(KERNEL_PATH)/system_dlkm/,$(TARGET_COPY_OUT_SYSTEM_DLKM)/lib/modules/5.15.167) \
...
ODM_MANIFEST_M7N_SS_FILES := $(DEVICE_PATH)/configs/vintf/manifest_nfc.xml
